...
Nova.booting(function (Vue, router) {
    ...
    Vue.component('form-badge', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c(
    "span",
    {
      ...
      style: {
        backgroundColor: _vm.field.colorMap[_vm.field.value],
        color: _vm.textColor(_vm.field.colorMap[_vm.field.value])
      }
    },
